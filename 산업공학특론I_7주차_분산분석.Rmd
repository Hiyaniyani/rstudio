...
# 데이터 전처리 1 - 변수 추출 (capacity)
dat_merge <- dat_merge[,c(1,2,grep("capacity", colnames(dat_merge)))] # grep:벡터에서 찾고자 하는 문자열 찾아주는 함수
head(dat_merge)
...
for (i in 2:4){
  points(dat_merge$cycle, dat_merge[,i], col=i, pch=16)
}
