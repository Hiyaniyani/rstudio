...
corrplot(corr_p, col=col(200), method="square", addCoef.col="black", type="upper")
corrplot(corr_k, col=col(200), method="square", addCoef.col="black", type="upper")
corrplot(corr_s, col=col(200), method="square", addCoef.col="black", type="upper")
...
plot(x, y, pch=16)
abline(a=reg$coef[1], b=reg$coef[2], col="red") # y = a + bx
