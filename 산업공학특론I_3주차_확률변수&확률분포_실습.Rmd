...
dat$AirtemperatureK <- as.numeric(dat$AirtemperatureK)
dat$ProcesstemperatureK <- as.numeric(dat$ProcesstemperatureK)
dat$Rotationalspeedrpm <- as.numeric(dat$Rotationalspeedrpm)
dat$TorqueNm <- as.numeric(dat$TorqueNm)
dat$Toolwearmin <- as.numeric(dat$Toolwearmin)
